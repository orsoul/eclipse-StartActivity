...
public class SendTask implements Runnable {
	...
	/** 出库上传袋信息(批量): $32 userID 03 bagid pinumber taskcount# */
	...
	public void setProperty(int taskID, String taskcount, String... info) {
		switch (taskID) {
		case 500:// 上传袋id
	...
	public void setProperty(int taskID, String taskcount) {
		...
		case CODE_PRE_CLOSE_OUT:
			msg = ("$105 " + StaticString.userId + " 03" + " "
					...
					+ " " + taskcount + "#");
			break;
		case CODE_OUT_STORE_TASK: // 出库 表单
			msg = ("$" + CODE_OUT_STORE_TASK + " " + StaticString.userId + " "
		...
		case 799:// 上传开袋批编号
			msg = "$22 " + StaticString.userId + " " + "26" + " "
					...
					+ StaticString.bagtidcode + " " + StaticString.userIdcheck
					+ " " + StaticString.pinumber + " " + taskcount + "#";
			break;
		...
		case CODE_IN_STORE_UPLOAD_BAG_INFO:// 上传入库袋信息
			msg = "$22 " + StaticString.userId + " "
					...
					+ " " + StaticString.tid + " " + StaticString.bagtidcode
