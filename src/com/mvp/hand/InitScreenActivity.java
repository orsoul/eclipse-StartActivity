...
public class InitScreenActivity extends BaseActivity implements
		...
		com.mvp.hand.HandContract.View {
	...
	private String flag_bagModel="", flag_leixing1="", flag_leixing2="";
	...
	private void findView() {
		...
		init.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (bagModel != null) {
					...
					Log.i("建堆类型", leixing1_str + "|" + leixing2_str);
					/*if (flag_bagModel.equals(bagModel)
							&& flag_leixing1.equals(leixing1_str)
							&& flag_leixing2.equals(leixing2_str)) {
						createPileSuccess();
					}else{
						
						flag_bagModel = bagModel;
						flag_leixing1 = leixing1_str;
						flag_leixing2 = leixing2_str;
						dialogUtil.showProgressDialog("正在申请堆，请稍候...");
		 ...
		 * view, int position, long id) { bagModel = values[position]; }
		 * 
		...
		mRadioGroup
				.setOnCheckedChangeListener(new MyRadioGroup.OnCheckedChangeListener() {
					@Override
	...
	public void createPileSuccess() {
		...
		if (leixing1_str.equals("原封")) {
			...
			presenter.initScreen(bagModel, leixing1_str + "|" + leixing2_str,
					version_value, series);
		}
